...
MSE_PCA_VAR = zeros(N_Fors,1);
MSE_PCA_KNN = zeros(N_Fors,1);
MSE_DS_VAR  = zeros(N_Fors,1);
MSE_DS_KNN  = zeros(N_Fors,1);
MSE_MP_VAR  = zeros(N_Fors,1);
MSE_MP_KNN  = zeros(N_Fors,1);
